...
plt.scatter(data_size, insertion_time)
plt.scatter(data_size, selection_time)
plt.scatter(data_size, quick_time)
plt.scatter(data_size, merge_time)
plt.scatter(data_size, heap_time)
plt.grid()
plt.show()